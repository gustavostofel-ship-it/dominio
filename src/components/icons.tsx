// Ícones outline minimalistas (inline SVG, sem dependência externa).
// Todos usam stroke="currentColor" para herdar a cor do texto do link.
...
export function IconCheck({ className = base }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" className={className}>
      ...
      <path d="M7.5 12l3 3 6-6" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  );
}
...
export function IconReceive({ className = base }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" className={className}>
      <path d="M12 4v13M12 17l-4.5-4.5M12 17l4.5-4.5" strokeLinecap="round" strokeLinejoin="round" />
...
export function IconUsers({ className = base }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" className={className}>
      ...
      <path d="M15.7 14.2c2.4.4 4.3 2.2 4.3 4.8" strokeLinecap="round" />
    </svg>
  );
}
...
export function IconImport({ className = base }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" className={className}>
      <path d="M12 3v11M12 14l-3.5-3.5M12 14l3.5-3.5" strokeLinecap="round" strokeLinejoin="round" />
      <path d="M4.5 16v2.5A2.5 2.5 0 0 0 7 21h10a2.5 2.5 0 0 0 2.5-2.5V16" strokeLinecap="round" />
    </svg>
  );
}
